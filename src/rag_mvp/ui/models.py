...
class EvaluationRender:
    ...
    quality_rows: tuple[tuple[Any, ...], ...] = ()
    quality_plot_rows: tuple[tuple[str, float], ...] = ()
    performance_rows: tuple[tuple[Any, ...], ...] = ()
    ...
    refusal_rows: tuple[tuple[Any, ...], ...] = ()
    system_rows: tuple[tuple[Any, ...], ...] = ()
...
class ComparisonRender:
    ...
    retrieval_rows: tuple[tuple[Any, ...], ...] = ()
    retrieval_plot_rows: tuple[tuple[str, str, float], ...] = ()
    model_rows: tuple[tuple[Any, ...], ...] = ()
    model_plot_rows: tuple[tuple[str, str, float], ...] = ()
    artifact_rows: tuple[tuple[Any, ...], ...] = ()
    progress_markdown: str = ""
    gate_markdown: str = ""
    cache_conclusion_markdown: str = ""
    recommendation_markdown: str = ""
    retrieval_recommendation_markdown: str = ""
    model_recommendation_markdown: str = ""
    artifact_links_markdown: str = ""
    status_markdown: str = ""
    poll_active: bool = False
    start_enabled: bool = False

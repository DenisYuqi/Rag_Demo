...
| vector-and-hybrid | complete | `evidence/retrieval-reranker-comparison.json` | comparison | The historical three-mode retrieval comparison uses OpenAI embeddings and reranking, so it demonstrates the required alternatives but does not substitute for the selected BGE profile quality gate. |
...
| three-retrieval-configurations | complete | `evidence/retrieval-reranker-comparison.json` | comparison | The historical three-mode retrieval comparison uses OpenAI embeddings and reranking, so it demonstrates the required alternatives but does not substitute for the selected BGE profile quality gate. |
